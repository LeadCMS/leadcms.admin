...
export const themeOptions: ThemeOptions = {
  ...
  palette: {
    ...
    terminal: {
      background: "hsla(214, 64%, 10%, 1)",
      foreground: "hsl(0, 0%, 85%)",
      cursor: "hsl(200, 100%, 60%)",
      black: "hsl(0, 0%, 0%)",
      red: "hsl(0, 70%, 50%)",
      green: "hsla(144, 77%, 59%, 1)",
