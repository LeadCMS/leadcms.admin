...
import { CommentCreateDto, CommentDetailsDto, CommentUpdateDto } from "@lib/network/swagger-client";
...
export const CommentsModule = () => {
  ...
  const module = GenericModule({
    ...
    editFormProps: {
      ...
      onSaved: () => {
        navigate(getCoreModuleRoute(CoreModule.comments));
      },
    },
    createFormProps: {
      ...formProps,
